...
- **パッケージ管理**: `package-mapping.toml` で apt/brew/cask のパッケージ名を一元管理。brewfile と apt install リストを自動生成。
...
2. **リポジトリを適用**
   ...
   # SSH
   OP_ACCOUNT=my.1password.com chezmoi init --apply git@github.com:tnmt/dotfiles.git
